<template>
    <div class="calvinKleinPage">
        <!-- Navbar -->
        <navbar_fashion></navbar_fashion>

        <!-- Header -->
        <header_calvinKlein></header_calvinKlein>
...
import header_calvinKlein from '../../fashion_store/CalvinKlein/HeaderCalvinKlein.vue';
import footer_fashion from '../../fashion_store/FooterFashion.vue';

export default {
    name: "calvinKlein_page",
    components: {
        navbar_fashion,
        header_calvinKlein,
        footer_fashion,
    ...
    methods: {
        ...
        getProducts() {
            axios.get('api/products')
                .then(response => {
                    this.products = response.data.filter(product => product.brand_id === 5);
