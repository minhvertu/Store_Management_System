<template>
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-2 shadow-none border-radius-xl" :class="this.$store.state.isRTL ? 'top-0 position-sticky z-index-sticky' : ''
      ...
      <div class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4"
        ...
        <ul class="navbar-nav justify-content-end">
          <li class="px-3 nav-item d-flex align-items-center">
              <h6 class="mb-0 font-weight-bolder">{{ users.name }}</h6>
          </li>
          ...
          <li class="px-3 nav-item d-flex align-items-center">
            <a class="p-0 nav-link text-white" @click="toggleConfigurator">
              <i class="cursor-pointer fa fa-cog fixed-plugin-button-nav" style="color: #e67099;"></i>
              <!-- <i class="cursor-pointer material-symbols-outlined" style="color: black;">settings</i> -->
            </a>
          </li>
          <li class="nav-item dropdown d-flex align-items-center" :class="this.$store.state.isRTL ? 'ps-2' : 'pe-2'">
            <a href="#" class="p-0 nav-link text-white" :class="[showMenu ? 'show' : '']" id="dropdownMenuButton"
              ...
              <i class="fa-solid fa-bell fa-lg fa-bounce" style="color: #74C0FC;"></i>
...
<script>
import Breadcrumbs from "../Navbars/Breadcrumbs.vue";
