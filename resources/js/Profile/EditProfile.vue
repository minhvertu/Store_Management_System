              ...
              <div class="avatar avatar-xl position-relative">
                <div class="height-100 d-flex justify-content-center align-items-center">
                  <button type="button" class=" p-0 position-relative" data-bs-toggle="modal"
                    ...
                    <img :src="'storage/' + imageUrl" alt="profile_image" class="shadow-sm w-100 border-radius-lg"  style="object-fit: cover;"/>
                    <!-- <img src="../../assets/img/team-1.jpg" alt="profile_image"
                      class="shadow-sm w-100 h-100 border-radius-lg" style="object-fit: cover;"> -->
                    <span class="position-absolute top-50 start-50 translate-middle" style="font-size: 24px;">
                ...
                <ul class="p-1 bg-transparent nav nav-pills nav-fill" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="px-0 py-1 mb-0 nav-link" data-bs-toggle="tab" href="javascript:;" role="tab"
                      ...
                      <img :src="'storage/' + imageUrl" alt="profile_image" class="shadow-sm w-100 border-radius-lg" />
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="px-0 py-1 mb-0 nav-link" data-bs-toggle="tab" href="javascript:;" role="tab"
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0" style="font-weight: bold;">Edit Profile Form</p>
